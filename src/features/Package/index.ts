...
export const getAllUserPackages = async (
    ...
    try {
        ...
        const data: ResponseDTO<PaginatedResult<UserPackagesCustom>> = response.data;
        ...
        message.error(
            error?.response?.data?.message || "An unexpected error occurred while fetching user packages."
        );
        console.error(error);
        return null;
    }
...
export const getUserPackageById = async (
    ...
    try {
        ...
        message.error(
            error?.response?.data?.message || "An unexpected error occurred while fetching user package."
        );
        console.error(error);
        return null;
    }
...
export const createUserPackage = async (
    ...
    try {
        ...
        message.error(
            error?.response?.data?.message || "An unexpected error occurred while purchasing package."
        );
        console.error(error);
        return null;
    }
...
export const updateUserPackage = async (
    ...
    try {
        ...
        message.error(
            error?.response?.data?.message || "An unexpected error occurred while updating package."
        );
        console.error(error);
        return null;
    }
...
export const deleteUserPackage = async (
    ...
    try {
        ...
        message.error(
            error?.response?.data?.message || "An unexpected error occurred while deleting package."
        );
        console.error(error);
        return null;
    }
...
export const filterUserPackages = async (
    ...
    try {
        ...
        message.error(
            error?.response?.data?.message || "An unexpected error occurred while filtering user packages."
        );
        console.error(error);
        return null;
    }
