          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-100 text-sm">
                Để tham gia đấu giá, bạn cần thanh toán một trong các gói phí
                dưới đây
              </p>
            </div>
          </div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {fees.map((fee, index) => {
                ...
                const isSelected =
                  selectedFee?.auctionsFeeId === fee.auctionsFeeId;
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-6">
                      <div
                        className={`w-16 h-16 rounded-2xl ${bgColor} flex items-center justify-center mb-4`}
                      >
              ...
              {selectedFee ? (
                <>
                  ...
                  <span className="font-semibold text-blue-600">
                    {formatPrice(selectedFee.entryFee)}{" "}
                    {selectedFee.currency || "VNĐ"}
                  </span>
                </>
              ) : (
