...
import { UploadOutlined, CarOutlined, ThunderboltOutlined, DollarOutlined, PictureOutlined, CheckCircleOutlined } from "@ant-design/icons";
                        ...
                        >
                            ...
                            >
                                <Space align="center" className="mb-8">
                                    ...
                                    <Title level={3} className="!mb-0 text-blue-900" style={{ fontSize: '1.75rem', fontWeight: 700 }}>
                                        Thông tin cơ bản
                                    </Title>
                                </Space>
                                ...
                                <Row gutter={[24, 24]}>
                                    <Col xs={24} md={12}>
                                        <Form.Item
                                            name="vehicleBrand"
                                            label={<span className="font-bold text-blue-900 text-base">Hãng xe</span>}
                                    ...
                                    <Col xs={24} md={12}>
                                        <Form.Item
                                            name="vehicleModel"
                                            label={<span className="font-bold text-blue-900 text-base">Mẫu xe</span>}
                                ...
                                <Row gutter={[24, 24]}>
                                    <Col xs={24} sm={8}>
                                        <Form.Item
                                            name="vehicleYear"
                                            label={<span className="font-bold text-blue-900 text-base">Năm sản xuất</span>}
                                    ...
                                    <Col xs={24} sm={8}>
                                        <Form.Item
                                            name="vehicleColor"
                                            label={<span className="font-bold text-blue-900 text-base">Màu sắc</span>}
                                    ...
                                    <Col xs={24} sm={8}>
                                        <Form.Item
                                            ...
                                            label={<span className="font-bold text-blue-900 text-base">Dòng xe</span>}
                            ...
                            >
                                ...
                                <Row gutter={[24, 24]}>
                                    <Col xs={24} sm={8}>
                                        <Form.Item
                                            name="vehicleRangeKm"
                                            label={<span className="font-bold text-blue-900 text-base">Quãng đường (km)</span>}
                                    ...
                                    <Col xs={24} sm={8}>
                                        <Form.Item
                                            ...
                                            label={<span className="font-bold text-blue-900 text-base">Công suất (kW)</span>}
                                    ...
                                    <Col xs={24} sm={8}>
                                        <Form.Item
                                            name="vehiclePrice"
                                            label={<span className="font-bold text-blue-900 text-base">Giá bán (VNĐ)</span>}
                            ...
                            >
                                ...
                                <Form.Item
                                    ...
                                    label={<span className="font-bold text-blue-900 text-base">Mô tả chi tiết</span>}
