...
// // import { message, Spin, Empty, Tag, Card, Statistic } from "antd";
// // import {
// //   CheckCircleOutlined,
// //   ClockCircleOutlined,
// //   CloseCircleOutlined,
...
// //             />
// //           </Card>
// //           <Card className="shadow-md hover:shadow-lg transition-shadow border-t-4 border-yellow-500">
// //             <Statistic
...
// //             />
// //           </Card>
// //           <Card className="shadow-md hover:shadow-lg transition-shadow border-t-4 border-blue-600">
// //             <Statistic
// //               title="Tổng chi tiêu"
...
// //                 className="shadow-md hover:shadow-xl transition-all duration-300 border-l-4 border-blue-500"
// //                 hoverable
// //               >
// //                 <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
// //                   {/* Payment ID & Status */}
// //                   <div className="md:col-span-2">
// //                     <div className="text-xs text-gray-500 mb-1">Mã GD</div>
// //                     <div className="font-semibold text-blue-600">
// //                       #{payment.paymentsId}
// //                     </div>
// //                     <div className="mt-2">{getStatusTag(payment.status)}</div>
// //                   </div>
...
// //                         Đã xác nhận: {formatDate(payment.updatedAt)}
// //                       </div>
// //                     )}
// //                   </div>
// //                 </div>
